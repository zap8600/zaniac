#! /bin/sh
clang -target riscv64-elf -fpic -fPIC -fshort-wchar -ffreestanding -fno-stack-protector -Wshadow -Wall -Wunused -Werror-implicit-function-declaration -c main.c -o main.o
